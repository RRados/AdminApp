...
namespace AdminApp.Migrations
{
    ...
    [Migration("20230128145553_updateRole")]
            ...
            modelBuilder.Entity("AdminApp.Models.LogIn", b =>
                {
                    ...
                    b.HasOne("AdminApp.Models.User", "Username")
                        .WithMany()
                        .HasForeignKey("UsernameIdUser")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
